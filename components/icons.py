...
A small local icon set in the Lucide icon style (open-source MIT icon
library: https://lucide.dev), inlined as raw SVG strings so the dashboard
has no emoji anywhere and no external network dependency at render time.

Usage:
    from components.icons import icon
    st.markdown(icon("scale", size=20, color="#3B82F6"), unsafe_allow_html=True)
"""
...
_PATHS = {
    ...
    "book-text": '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15Z"/><path d="M8 7h8"/><path d="M8 11h8"/>',
    "file-bar-chart": '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4 22h16a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4"/><path d="M8 18v-2"/><path d="M12 18v-4"/><path d="M16 18v-6"/><path d="M2 14v6"/>',
    "info": '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',
    "search-x": '<path d="m13.5 8.5-5 5"/><path d="m8.5 8.5 5 5"/><circle cx="10" cy="10" r="8"/><path d="m21 21-4.35-4.35"/>',
